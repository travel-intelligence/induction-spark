...
// BigDL
val bigdlVersion = "0.1.1"
val libbigdl = "com.intel.analytics.bigdl" % "bigdl-SPARK_2.1" % bigdlVersion
// val libbigdl = "com.intel.analytics.bigdl.native" % "mkl-java-mac" % bigdlVersion from "http://repo1.maven.org/maven2/com/intel/analytics/bigdl/native/mkl-java-mac/0.1.1/mkl-java-mac-0.1.1.jar"

lazy val commonSettings = Seq (
        organization := "com.veon.ti.ds",
        version := "0.1.0",
